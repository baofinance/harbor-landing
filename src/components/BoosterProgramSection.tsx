    ...
    <section className="relative z-10 bg-nautical-blue-light px-3 sm:px-4 md:px-5 pb-3 sm:pb-4 md:pb-5 pt-0">
      <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 md:gap-5 items-stretch">
        ...
        <div className="lg:w-2/3 bg-white p-6 sm:p-10 md:p-12 lg:p-14">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-2 md:gap-4 lg:gap-6 xl:gap-10 h-full">
            ...
            <div className="w-full sm:w-7/12 flex flex-col justify-center text-left gap-4 sm:gap-5 md:gap-6 sm:pl-1.5 sm:pl-2 md:pl-4 lg:pl-6 xl:pl-10 min-w-0">
              ...
              <div className="flex flex-row items-center gap-2 sm:gap-2 md:gap-3 lg:gap-4 min-w-0">
                <a
                  href="https://docs.harborfinance.io/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-[140px] sm:w-[150px] md:w-[160px] lg:w-[170px] flex-shrink-0 px-2 sm:px-3 md:px-4 py-2 sm:py-2.5 text-[10px] sm:text-xs md:text-sm font-semibold border border-nautical-blue text-nautical-blue rounded-full hover:bg-nautical-blue/10 transition-colors text-center whitespace-nowrap"
                >
                  Learn more
                </a>
                <Link
