  ...
  return (
    <footer className="relative z-10 bg-nautical-blue">
      <div className="mx-auto max-w-[1300px] px-4 sm:px-10 py-12">
        <div className="mb-12 rounded-2xl border border-white/15 bg-white/[0.06] px-6 py-10 text-center shadow-[0_8px_32px_rgba(0,0,0,0.15)] sm:px-10 sm:py-12 md:mb-16">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <a
              ...
              className="w-full max-w-[200px] rounded-full border border-white bg-white px-5 py-2.5 text-sm font-semibold text-nautical-blue transition-all hover:bg-white/90 sm:w-auto sm:px-6 sm:text-base"
            >
              Launch App
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full max-w-[200px] rounded-full border border-white px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-white/10 sm:w-auto sm:px-6 sm:text-base"
            >
              Read Docs
            </a>
          </div>
