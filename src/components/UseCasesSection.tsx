...
export default function UseCasesSection() {
  return (
    <section className="relative z-10 bg-nautical-blue-light px-3 sm:px-4 md:px-5 pb-3 sm:pb-4 md:pb-5 pt-0">
      <div className="flex flex-col items-stretch gap-3 sm:gap-4 md:gap-5 lg:flex-row">
        <div className="order-2 flex flex-col bg-white p-6 sm:p-10 md:p-12 lg:order-1 lg:w-1/3 lg:p-14">
          <ScrollingMarkets />
        </div>

        <div className="order-1 bg-nautical-blue p-6 sm:p-10 md:p-12 lg:order-2 lg:w-2/3 lg:p-14">
          <div className="flex h-full flex-row gap-1.5 sm:gap-2 md:gap-4 lg:gap-6 xl:gap-10">
